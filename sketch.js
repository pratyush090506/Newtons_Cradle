...
function setup() {
	...
	Ball1 = new Ball(500,400,50,PI/2);
	Ball2 = new Ball(550,400,50,PI/2);
	Ball3 = new Ball(600,400,50,PI/2);
	Ball4 = new Ball(650,400,50,PI/2);
	Ball5 = new Ball(700,400,50,PI/2);
...
function keyPressed(){
	...
	if(keyCode === UP_ARROW){
		...
		Matter.Body.applyForce(Ball1.body,Ball1.body.position,{x:-400,y:-300});
